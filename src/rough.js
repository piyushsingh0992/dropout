let allMentorDetails = [
  {
    mentorLogin: {
      userName: "Tanay Praap",
    ...
    mentorDetails: {
      userId: "",
      heroImage:
        "https://res.cloudinary.com/dvib6j4ie/image/upload/v1626360400/dropOut/tanay/i02_tanay2-removebg-preview_cyd8sf.png",
      displayImage:
        "https://res.cloudinary.com/dvib6j4ie/image/upload/v1626360400/dropOut/tanay/profile_my2in9.png",
      description:
        "Tanay is a Senior Software enginner at Microsoft and founder of NeogCamp,Roc8",
      name: "Tanay Praap",
      subject: "Tech Mentor",
    ...
    mentorPlaylists: ["Tea with Tanay", "Carrer moves", "Neog Camp"],
  },
  {
    mentorLogin: {
      userName: "Varun Mavya",
      userId: "varun@neog.com",
      password: "varun@2020",
      mentor: true,
    },
    ...
    mentorDetails: {
      userId: "",
      heroImage:
        "https://res.cloudinary.com/dvib6j4ie/image/upload/v1626360431/dropOut/varun/hero_tttxxy.png",
      displayImage:
        "https://res.cloudinary.com/dvib6j4ie/image/upload/v1626360432/dropOut/varun/profile_qnkh4a.png",
      description:
        "Varun is the Founder of avalon meta,Scenes, and writer of PyjamaProfits",
      name: "Varun Mavya",
    ...
    mentorPlaylists: ["Meta Start up", "Cero"],
  },
  {
    mentorLogin: {
      userName: "Shashank Udupa",
      userId: "shashank@neog.com",
      password: "shashank@2020",
      mentor: true,
    },
    ...
    mentorDetails: {
      userId: "",
      heroImage:
        "https://res.cloudinary.com/dvib6j4ie/image/upload/v1626360469/dropOut/shashank/hero_hltnzi.png",
      displayImage:
        "https://res.cloudinary.com/dvib6j4ie/image/upload/v1626360470/dropOut/shashank/profile_qnjbdc.png",
      description:
        "Shashank Udupa is an ex-investment Banker, founder of avalon-meta,scenes and most of all a financial Wizard",
      name: "Shashank Udupa",
    ...
    mentorPlaylists: ["World Of Finance", "IPO review"],
  },
  {
    mentorLogin: {
      userName: "Abhinav Gupta",
      userId: "abhinav@neog.com",
      password: "abhinav@2020",
      mentor: true,
    },
    ...
    mentorPlaylists: ["Podcasts"],
  },
  {
    mentorLogin: {
      userName: "Abhinav Chikara",
      userId: "abhinavChikara@neog.com",
      password: "abhinavChikara@2020",
      mentor: true,
    },
    ...
    mentorDetails: {
      userId: "",
      heroImage:
        "https://res.cloudinary.com/dvib6j4ie/image/upload/v1626360656/dropOut/abhinavChikara/hero_f5a8hd.png",
      displayImage:
        "https://res.cloudinary.com/dvib6j4ie/image/upload/v1626360658/dropOut/abhinavChikara/profile_j1iss7.png",
      description: "Abhinav is True Designer and founder of 10KDesigner's ",
    ...
    mentorPlaylists: ["Interview with designers", "Design Crashcourse"],
  },
  {
    mentorLogin: {
      userName: "Prakhar Gupta",
      userId: "prakhar@neog.com",
      password: "prakhar@2020",
      mentor: true,
    },
    ...
    mentorDetails: {
      userId: "",
      heroImage:
        "https://res.cloudinary.com/dvib6j4ie/image/upload/v1626360693/dropOut/prakhar/hero_pnqkdh.png",
      displayImage:
        "https://res.cloudinary.com/dvib6j4ie/image/upload/v1626360693/dropOut/prakhar/profile_aayz76.png",
      description: `Prakhar is a wizard when it comes to conversation , He run's a youtube channels "Prakhar ke pravachan" and "PG Radio"`,
      name: "Prakhar Gupta",
    ...
    mentorPlaylists: ["Live Talks", "Spirituality", "Papa ke Pravachan"],
  },
];
let allPlaylists = [
  {
